...
class CreateLandlordActivity : AppCompatActivity(),OnClickListener {
    ...
    override fun onClick(v: View?) {
            ...
            )
        {
            ...
            if (this.binding.etContact.text.isNullOrEmpty()) this.binding.etContact.setError("Can't Be Empty")
            if (this.binding.etEmail.text.isNullOrEmpty()) this.binding.etEmail.setError("Can't Be Empty")
            if (this.binding.etPassword.text.isNullOrEmpty()) this.binding.etPassword.setError("Can't Be Empty")
        }
        else
        {
//            TODO check if email is already a LANDLORD USER

            val newLandlord = Landlord(this.binding.etName.text.toString(),
            ...
            val intent = Intent(this@CreateLandlordActivity, LandlordLoginActivity::class.java)
